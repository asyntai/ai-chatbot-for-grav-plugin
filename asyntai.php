...
class AsyntaiPlugin extends Plugin
{
    ...
    private function handleSaveRequest(): void
    {
        ...
        $current = (array)$this->config->get('plugins.asyntai');
    ...
    private function writePluginConfig(array $data): void
    {
        ...
        $path = $locator->findResource('user://config/plugins/asyntai.yaml', true, true);
        ...
        $this->config->set('plugins.asyntai', $merged);
    }
    ...
    public function onTwigInitialized(): void
    {
        ...
        $twig->addFunction(new \Twig\TwigFunction('asyntai_widget', function () {
            $cfg = (array)$this->config->get('plugins.asyntai');
